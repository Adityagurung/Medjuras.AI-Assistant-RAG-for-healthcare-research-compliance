...
allowed_name_regex='^(aditya-gurung-bayer)$'
allowed_email_regex='^(aditya.gurung@bayer.com)$'
...
fail() {
  ...
  echo "     git config user.name 'aditya-gurung-bayer'"
  echo "     git config user.email 'aditya.gurung@bayer.com'"
  exit 1
}
